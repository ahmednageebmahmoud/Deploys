var App = function () {
    ...
    let categoryScrollApp = {
        scrollCat: function () {
            let sidebarWrapper = document.querySelectorAll('.sidebar-wrapper [aria-expanded="true"]')[0];
            let sidebarWrapperTop = (sidebarWrapper?.offsetTop || 20) - 20;
